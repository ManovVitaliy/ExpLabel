 ...
 * ExpandableLabel
 */
open class ExpandableLabelNew: UILabel {
    ...
    open override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if !collapsed {
            ...
            if shouldCollapse && ExpandableLabelNew.isTouchInLabelRange(touch: touch, label: self, inRange: range) {
    ...
    @discardableResult fileprivate func setLinkHighlighted(_ touches: Set<UITouch>?, event: UIEvent?, highlighted: Bool) -> Bool {
        ...
        if collapsed && ExpandableLabelNew.isTouchInLabelRange(touch: touch, label: self, inRange: range) {
